...
The file may contain any columns you wish. The app will ask you to select an "id" column (e.g., feature id), the columns containing the samples and a column with  compound names.
